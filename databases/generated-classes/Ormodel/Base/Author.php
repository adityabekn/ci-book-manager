...
abstract class Author implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Ormodel\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Ormodel\Base\Author object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Ormodel\\Author'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Ormodel\Author (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ormodel\Author Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
