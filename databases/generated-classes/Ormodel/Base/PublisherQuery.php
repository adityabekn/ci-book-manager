...
use \Exception;
use \PDO;
use Ormodel\Publisher as ChildPublisher;
use Ormodel\PublisherQuery as ChildPublisherQuery;
use Ormodel\Map\PublisherTableMap;
 ...
 *
 * @method     ChildPublisher[]|Collection findById(int|array<int> $id) Return ChildPublisher objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildPublisher> findById(int|array<int> $id) Return ChildPublisher objects filtered by the id column
 * @method     ChildPublisher[]|Collection findByName(string|array<string> $name) Return ChildPublisher objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildPublisher> findByName(string|array<string> $name) Return ChildPublisher objects filtered by the name column
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Ormodel\Base\PublisherQuery object.
     *
