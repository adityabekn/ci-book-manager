...
class AuthorTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Ormodel.Map.AuthorTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'Author';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Ormodel\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Ormodel.Author';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Ormodel\\Author');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Ormodel\Author) { // it's a model object
