...
class BookTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Ormodel.Map.BookTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'Book';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Ormodel\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Ormodel.Book';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Ormodel\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\Ormodel\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Ormodel\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Ormodel\Book) { // it's a model object
