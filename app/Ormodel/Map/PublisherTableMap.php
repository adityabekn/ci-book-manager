...
class PublisherTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Ormodel.Map.PublisherTableMap';
     ...
     */
    public const OM_CLASS = '\\Ormodel\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Ormodel.Publisher';
     ...
     */
    public const COL_ID = 'publisher.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'publisher.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [PublisherTableMap::COL_ID, PublisherTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [PublisherTableMap::COL_ID => 0, PublisherTableMap::COL_NAME => 1, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'publisher.id' => 'ID',
        'PublisherTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Publisher.Name' => 'NAME',
        'name' => 'NAME',
        'publisher.name' => 'NAME',
        'PublisherTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Ormodel\\Publisher');
        $this->setPackage('Ormodel');
    ...
    {
        $this->addRelation('Book', '\\Ormodel\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(PublisherTableMap::COL_ID);
            $criteria->removeSelectColumn(PublisherTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Ormodel\Publisher) { // it's a model object
