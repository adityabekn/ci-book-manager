 ...
 *
 *
 * @package    propel.generator.Ormodel.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Ormodel\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Ormodel\Base\Publisher object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Ormodel\\Publisher'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Ormodel\Publisher (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ormodel\Publisher Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initBooks(bool $overrideExisting = true): void
    {
        ...
        $this->collBooks->setModel('\Ormodel\Book');
    }
        ...
        if (null === $this->collBooks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collBooks) {
                    ...
                    $collBooks->setModel('\Ormodel\Book');
