...
use \Exception;
use \PDO;
use Ormodel\Author as ChildAuthor;
use Ormodel\AuthorQuery as ChildAuthorQuery;
use Ormodel\Map\AuthorTableMap;
 ...
 *
 * @method     \Ormodel\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildAuthor[]|Collection findById(int|array<int> $id) Return ChildAuthor objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildAuthor> findById(int|array<int> $id) Return ChildAuthor objects filtered by the id column
 * @method     ChildAuthor[]|Collection findByFirstName(string|array<string> $first_name) Return ChildAuthor objects filtered by the first_name column
 * @psalm-method Collection&\Traversable<ChildAuthor> findByFirstName(string|array<string> $first_name) Return ChildAuthor objects filtered by the first_name column
 * @method     ChildAuthor[]|Collection findByLastName(string|array<string> $last_name) Return ChildAuthor objects filtered by the last_name column
 * @psalm-method Collection&\Traversable<ChildAuthor> findByLastName(string|array<string> $last_name) Return ChildAuthor objects filtered by the last_name column
 *
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Ormodel\Base\AuthorQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'example-ci', $modelName = '\\Ormodel\\Author', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Ormodel\Book object
     *
     * @param \Ormodel\Book|ObjectCollection $book the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    ...
    {
        if ($book instanceof \Ormodel\Book) {
            $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Ormodel\Book or Collection');
        }
    }
     ...
     *
     * @return \Ormodel\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Ormodel\BookQuery');
    }

    /**
     * Use the Book relation Book object
     *
     * @param callable(\Ormodel\BookQuery):\Ormodel\BookQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \Ormodel\BookQuery The inner query object of the EXISTS statement
     */
    public function useBookExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Ormodel\BookQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Ormodel\BookQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \Ormodel\BookQuery The inner query object of the IN statement
     */
    public function useInBookQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Ormodel\BookQuery */
     ...
     *
     * @return \Ormodel\BookQuery The inner query object of the NOT IN statement
     */
    public function useNotInBookQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Ormodel\BookQuery */
